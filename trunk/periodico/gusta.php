...
$estearticulo = mysql_query("SELECT * FROM articulos WHERE id_articulo=$_GET[articulo_id]");
if(mysql_num_rows($estearticulo)>0){
$estearticulov = mysql_query("SELECT * FROM articulos_votos WHERE id_articulo=$_GET[articulo_id] AND id_votador=$id_usuario");
if(mysql_num_rows($estearticulov)>0){
if($_GET['doing']==3){
