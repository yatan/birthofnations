...
if (isset($_POST['cantidad']) && $_POST['cantidad'] != "" && is_numeric($_POST['cantidad']) && isset($_POST['precio']) && $_POST['precio'] != "" && is_numeric($_POST['precio']))
{
    ...
    sql("INSERT INTO mercado_objetos(id_pais, id_empresa, objeto, precio, cantidad) VALUES ('". $empresa['pais'] ."','". $_POST['id_empresa'] ."','". nombre_item($empresa['tipo']) ."','". $_POST['precio'] ."','". $_POST['cantidad'] ."') ");
