...
if(!isset ($_GET['access_token'])){
    ...
    ?>
        <a href="https://graph.facebook.com/oauth/authorize?type=user_agent&client_id=215454291835577&redirect_uri=http://www.birthofnations.com/snetworks/facebook/index.php&scope=offline_access,manage_pages">clic aquí</a>
    <?
}else{
