                                ...
                                <div id="fila2" style="width: 59.6em; height: 14.5em;">
                                    <div id="periodicos_login" style="float: left; width: 29.5em; height: 14.5em;">
                                        <div class="ultimos_articulos" style="float: left; width:300px;">
                                            <h2>
                                                <li><?php echo getString('periodico_ultimos'); ?></li>
                                            </h2>
                                            <?php
                                            global $link;
                                            $nuevosarticulosw = mysqli_query($link, "SELECT * FROM articulos ORDER by fecha DESC LIMIT 5");
                                            echo "<div style='text-align: left; margin-left: 5px;'>";
                                            while ($nuevosarticulos = mysqli_fetch_array($nuevosarticulosw)) {
...
HTML;
                                        ...
                                        <div class="ultimos_articulos" style="float: right;">
                                            <h2>
                                                <li><?php echo getString('periodico_top'); ?></li>
                                            </h2>
                                            <?php
                                            global $link;
                                            $fechalimite = (time() - (((60 * 60) * 24) * 5));
                                            $artivotos = array('articuloid' => array(), 'numvotos' => array(), 'nombre' => array());
                                            $nuevosarticulosw = mysqli_query($link, "SELECT * FROM articulos WHERE fecha>$fechalimite ORDER by fecha DESC");
                                            while ($nuevosarticulos = mysqli_fetch_array($nuevosarticulosw)) {
                                                $nuevosarticuloswv = mysqli_query($link, "SELECT * FROM articulos_votos WHERE id_articulo='" . $nuevosarticulos['id_articulo'] . "' AND tipo=1");
                                                array_push($artivotos['articuloid'], $nuevosarticulos['id_articulo']);
                                                array_push($artivotos['nombre'], $nuevosarticulos['titulo']);
                                                array_push($artivotos['numvotos'], mysqli_num_rows($nuevosarticuloswv));
                                            }
...
HTML;
                                    ...
                                    <div id="guerras_login" style="float: right; width: 30em; height: 14.5em;">
                                        <h2><?php echo getString('last_wars'); ?></h2>
                                        <p>pais de las piruletas ha perdido contra pais del regaliz</p>
                                    </div>
                                </div>
